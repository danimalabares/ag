...
\subsubsection{Lecture 1 by Lucas}
...
\subsubsection{Summary of Hartshorne section 3}
...
\subsubsection{Summary from da Silva, Symplectic Toric Manifolds}
...
\subsection{The Segre embedding (extra)}
...
\subsection{The quadric surface in $\mathbb{P}^3$ (Bruno)}
